...
##plots
plot(timestamp, Sub_Data$Global_active_power, ylab = "Global Active Power",
     xlab = "", type = "l")
plot(timestamp, Sub_Data$Voltage, ylab = "Voltage", xlab = "datetime",
     type = "l")
plot(timestamp, Sub_Data$Sub_metering_1, ylab = "Energy Sub Metering",
     xlab = "", type = "l")
...
legend("topright", lty = 1, col = c("black", "red", "blue"), 
       ...
       bty = "n")
plot(timestamp, Sub_Data$Global_reactive_power, ylab = "Global_reactive_power", xlab = "datetime", type = "l")
dev.off()